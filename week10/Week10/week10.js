...
function sayHello(message, guestName= 'Гость'){
console.log(`${message}, ${guestName}`)
}
sayHello('Здравствуй', 'Кот Ученый!');
...
console.log(
	'С момента летней олимпиады в Токио прошло ' + calculateYearsSinceLastOlympics(presentYear, lastOlympicsYear) + ' года',
);
...
function calculateAge(presentYear, friendYearOfBirth) {
	return presentYear - friendYearOfBirth;
}
console.log ('Моему другу сейчас '+ calculateAge(presentYear, friendYearOfBirth)+ ' лет.');
...
console.log('Тебе '+ calculateAge(presentYear, birthYear)+ ' лет.');
...
const resultOfExponentiation = exponentiation(2, 10);
console.log("Результат: " + resultOfExponentiation);